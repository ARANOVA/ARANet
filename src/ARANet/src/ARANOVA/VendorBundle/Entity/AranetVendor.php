...
/**
 * ARANOVA\ARANetBundle\Entity\AranetVendor
 *
 * @ORM\Table(name="aranet_vendor")
 * @ORM\Entity(repositoryClass="ARANOVA\ARANetBundle\Repository\VendorRepository")
 */
class AranetVendor
{
    /**
     ...
     * Get default contact
     *
     * @return ARANOVA/ARANetBundle/Entity/AranetVendorContact 
     */
     ...
     * Get default address
     *
     * @return ARANOVA/ARANetBundle/Entity/AranetVendorAddress 
     */
     ...
     *
     * @return ARANOVA/ARANetBundle/Entity/AranetStatistic 
     */
     ...
     * Add statistics
     *
     * @param ARANOVA\ARANetBundle\Entity\AranetVendorStatistic $statistics
     */
    public function addAranetVendorStatistic(\ARANOVA\ARANetBundle\Entity\AranetVendorStatistic $statistics)
    {
     ...
     *
     * @param ARANOVA\ARANetBundle\Entity\AranetKindOfCompany $vendorKindOfCompany
     */
    public function setVendorKindOfCompany(\ARANOVA\ARANetBundle\Entity\AranetKindOfCompany $vendorKindOfCompany)
    {
     ...
     *
     * @return ARANOVA\ARANetBundle\Entity\AranetKindOfCompany 
     */
     ...
     * Add contacts
     *
     * @param ARANOVA\ARANetBundle\Entity\AranetVendorContact $contacts
     */
    public function addAranetVendorContact(\ARANOVA\ARANetBundle\Entity\AranetVendorContact $contacts)
    {
     ...
     * Add addresses
     *
     * @param ARANOVA\ARANetBundle\Entity\AranetVendorAddress $addresses
     */
    public function addAranetVendorAddress(\ARANOVA\ARANetBundle\Entity\AranetVendorAddress $addresses)
    {

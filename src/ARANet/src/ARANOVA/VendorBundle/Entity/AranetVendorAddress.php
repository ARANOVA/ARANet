...
/**
 * ARANOVA\ARANetBundle\Entity\AranetVendorAddress
 *
...
class AranetVendorAddress
{
     ...
     * @var integer $address
     *
     * @ORM\OneToOne(targetEntity="AranetAddress")
     * @ORM\JoinColumns({
     ...
     * Set address
     *
     * @param ARANOVA\ARANetBundle\Entity\AranetAddress $address
     */
    public function setAddress(\ARANOVA\ARANetBundle\Entity\AranetAddress $address)
    {
     ...
     * Get address
     *
     * @return ARANOVA\ARANetBundle\Entity\AranetAddress 
     */

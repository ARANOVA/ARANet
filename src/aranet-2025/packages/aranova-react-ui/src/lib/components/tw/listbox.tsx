...
export function Listbox<T>({
  ...
  return (
    <Headless.Listbox {...props} multiple>
      ...
      >
        <Headless.ListboxSelectedOption
          as="span"
          options={options}
          placeholder={placeholder && <span className="block content-center truncate text-zinc-500">{placeholder}</span>}
          className={clsx([
            // Basic layout
            'relative space-x-3 flex w-full appearance-none rounded-lg',

...
import {
  ClientFormDataDTO,
  ClientInsertFormDataDTO,
  clientSchemaInsert,
} from "@/app/data/client/zodDataClient";

interface Props {
  defaultValues: ClientFormDataDTO;
  onSubmit: (data: ClientInsertFormDataDTO) => void;
}

export default function EditClientForm({ defaultValues, onSubmit }: Props) {

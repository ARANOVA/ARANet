...
import { cashColumns, cashFilters } from "@/app/data/cash";
...
export default async function CashListPage({ searchParams }: Props) {
    ...
    <>
      ...
      <div className="flex flex-col flex-1">
        ...
        <EditableStoreTable<any>
          ...
          newTitle="Añadir movimiento"
          viewTitle="Ver movimiento"
          ...
          filters={cashFilters}
          idField="id"
          sortField={sortField || 'cash_item_date'}

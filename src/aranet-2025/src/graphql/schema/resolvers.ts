...
export const resolvers = {
  ...
  Mutation: {
    ...
    updateInvoice: async (_: any, args: { id: number, data: unknown}, context: GraphQLContext) => {
      return await updateById(context.prisma, context.session, 'invoice', args.id, args.data);
    }
  },
  Budget: {
